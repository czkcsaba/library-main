...
echo <<<HTML
        <form method='post' action='/writers' enctype="multipart/form-data">
            ...
            <h2 class="form-title">Szerző szerkesztése</h2> 

            <div class="form-group">
                <label for="name">Író</label>
                <input type="text" name="name" id="name" value="{$writer->name}">
            </div>

            <div class="form-group">
                <label for="bio">Bio</label>
                <textarea type="text" name="bio" id="bio" class="bio">{$writer->bio}</textarea>
            </div>
